...
Current baseline is `versionCode 8, versionName "1.1.3"` (v1.1.3 adds
clipboard fallback for CSV export on native — Capacitor WebView blocks
`<a download>`). v1.1.2 fixed referral URL on native; v1.1.1 fixed
